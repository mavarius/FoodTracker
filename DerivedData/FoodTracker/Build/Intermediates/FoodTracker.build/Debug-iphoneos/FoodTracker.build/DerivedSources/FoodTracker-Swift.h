...
- (nullable instancetype)initWithName:(NSString * __nonnull)name photo:(UIImage * __nullable)photo rating:(NSInteger)rating OBJC_DESIGNATED_INITIALIZER;
...
- (IBAction)unwundToMealList:(UIStoryboardSegue * __nonnull)sender;
- (void)saveMeals;
...
- (IBAction)cancel:(UIBarButtonItem * __nonnull)sender;
- (void)prepareForSegue:(UIStoryboardSegue * __nonnull)segue sender:(id __nullable)sender;
- (IBAction)selectImageFromPhotoLibrary:(UITapGestureRecognizer * __nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic) NSInteger rating;
@property (nonatomic, copy) NSArray<UIButton *> * __nonnull ratingButtons;
@property (nonatomic, readonly) NSInteger spacing;
@property (nonatomic, readonly) NSInteger stars;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
- (CGSize)intrinsicContentSize;
- (void)ratingButtonTapped:(UIButton * __nonnull)button;
