...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func cancel(sender: UIBarButtonItem) {
        // Depending on style of presenetation (modal or push presentation), this view controller needs to be dismissed in two different ways.
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if saveButton === sender {
            ...
            // Set the meal to be pased to MealTableViewController after the unwind segue.
